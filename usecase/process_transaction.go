...
func NewUseCaseTransaction(transactionRepository domain.TransactionRepository) UseCaseTransaction {
	return UseCaseTransaction{TransctionRepository: transactionRepository}
}

func (u UseCaseTransaction) ProcessTransaction(transactionDto dto.Transaction) (domain.Transaction, error) {
	creditCard := u.hidrateCreditCard(transactionDto)
	ccBalanceAndLimit, err := u.TransctionRepository.GetCreditCard(*creditCard)
	if err != nil {
	...
	err = u.TransctionRepository.SaveTransaction(*t, *creditCard)
	if err != nil {
		return domain.Transaction{}, err
	}
...
func (u UseCaseTransaction) hidrateCreditCard(transactionDto dto.Transaction) *domain.CreditCard {
